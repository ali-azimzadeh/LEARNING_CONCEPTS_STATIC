namespace LEARNING_CONCEPTS
{
    internal static class Program
    {
        ...
        internal static void Main(string[] args)
        {
            ...
            //Magooli magooli = new Magooli();

            //magooli.FullName = "ali azimzadeh";

            ////magooli.Id


            //Magooli magooli1 = new Magooli();

            //magooli1.FullName = "Reza Ahmadi";



            //Googooli.FullName = "ali azimzadeh";

            //Googooli.ShowInfo();

            //Googooli.FullName = "Reza Ahmadi";
            ...
            string date = 
                ShamsiDate.GetPersianDate();

            System.Console.WriteLine("date {0} ", date);

            string dayName = 
                ShamsiDate.GetDayName().ToString();

            System.Console.WriteLine("Day of Week {0} ",dayName );
